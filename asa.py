...
cl = LINETCR.LINE()
cl.login(token="Em6ZF9hLH22VllPxR1Wa.0ikaZF3A5tcECFODftsw2G.ZwM+b2t7Guj9lAg4+ptEJ7VFcXRYZ5wLSDvQXUHS/g8=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Em0LQmdP30oIRC0F0lbb.BThkCee70z0HnBVOuvBn6W.vk72v2mv1cKqqE/fhChBGudRCk4Mjpo0YZI0ZU/PuXU=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Em1lfcr3dlMzDsPXWwoa.CZgRpE2PgJOBF+NlS+sJoG.YLlu+/h8p+oPMA7gkAxiTfDYBjjDMIeEgRITww6FIRM=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EmzHD2gJzKbMomIe6dd5.hvuIx6izAXCh7kigp+OEfq.soRFRwzmOf3sAN707ctjKp7EesZ61vuE6S2OIE3+ucg=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EmkWWgjDvCKHH2iQ677b.I9YBMfRqAE5FKjP6B2coYW.3E5Ku7LIJBYtf9KoBiv96m7WpqmLApFmv4hH99sjcyU=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Emu2BHGHT4Fjv4pe5iN2.N/RlxRz2fWJfjPHay81q4G.C2iwLBuYrV1x3zVCLshrW7NZZIumQXGQpiDF3F5kkIg=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="EmTCPXx7Y8iqzMNuTmra.sNjt4tJryJMsXVinsRKrwG.2WyKG6j1CfB9IWSQZ/rL+lT+L8FAiDsrJy8qwvQunnU=")
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token="Em21jkfZQVmlLRxCleBc.jFGC7fqRUB/KtU5LBYaMNa.hBrZ8CDObZRVcwut6Dig0LJYFFSnH20fGK47VgLTzAY=")
ki7.loginResult()
...
☬ [Reject Invite]~[Bi on - off]
☬ [Protect Cancel]~[Cn on - off]
☬ [Member Protect]~[M on - off]
"""
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,"ud08280cdfddae5309e71fa1d153496da"]
...
#-----------------------------------------------
                ...
                ki6.sendText(msg.to,"F.A.F ACTIVE")
                ki7.sendText(msg.to,"F.A.F ACTIVE")
#-----------------------------------------------
