...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EmmD39knhC0iv7ZlQWy4.z6heb3frOEzxUxMfp5E0na.Pp6q8bEiqVIbfCokuMZnVK0u69sYzus4ZkQcBlNYPTE=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='Em7rEHMrNS0w6ZYUA7B0.jsRuQemVTUfEEiBf9sQ68a.4VXiRVqvUv3c9Cr/qbvuRSBo9M+sTTg3w5kaxXY5aQE==')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Emj9pZurf9rorFspjPwd.68/qq7yBmK6vl3m3sPc1lq.C2ybwsDfHA2XYMJ8f3MBbPoif10deS1BVhD5my9m7Z8=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EmqABnCetrWosYmHfv71.qb6yA5FYR94NDNcW74Ocmq.ecMevRlZWvaVl/fFAFpgfu4Gl2KHmJg7w/sdhsDl33A=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='Emahp7pFnKoa9d2JiIY8.92a0RHOsoMLsca9dwZQM/a.ge0/VTgPgeik/UAXr/PjTq3o9rCQo73YUmkeSf6Y+E0=')
kr.loginResult()
...
Creator="ud08280cdfddae5309e71fa1d153496da"
...
#--------------------------------------------------------
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus Admin")
#--------------------------------------------------------
	    elif "Cr grup" in msg.text:
		thisgroup = cl.getGroups([msg.to])
		Mids = [contact.mid for contact in thisgroup[0].members]
		mi_d = Mids[:33]
		cl.createGroup("Cr group", mi_d)
